...
let authUrl = getArg(process.argv, 2, "Missing authentication URL", undefined);
let callbackUrl = getArg(process.argv, 3, "Missing callback URL", undefined);
let force = getArg(process.argv, 4, undefined, 'false') === 'true';
